...
$(function(){try{var e=new URLSearchParams(window.location.search);!$.cookie("utm_campaign")&&e.has("utm_campaign")&&$.cookie("utm_campaign",e.get("utm_campaign"),{expires:7,path:"/"});!$.cookie("li_src")&&e.has("src")&&$.cookie("li_src",e.get("src"),{expires:7,path:"/"});e.forEach(function(F,R){R.startsWith("utm_")&&sessionStorage.setItem(R,F)})}catch(F){}});
